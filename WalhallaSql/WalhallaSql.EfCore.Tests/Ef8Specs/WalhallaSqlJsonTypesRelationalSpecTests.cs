...
public sealed class WalhallaSqlJsonTypesRelationalSpecTests : JsonTypesRelationalTestBase
{
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => base.OnConfiguring(
            optionsBuilder.UseWalhallaSql(
                new WalhallaSqlEfCoreOptions("DataSource=ef8-json-types-relational;Database=App")));
